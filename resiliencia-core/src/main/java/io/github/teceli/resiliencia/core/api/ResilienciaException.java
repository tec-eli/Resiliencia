 ...
 */
public class ResilienciaException extends RuntimeException {

    @Serial
    private static final long serialVersionUID = 1L;

    public ResilienciaException(String message) {
        super(message);
    }

    public ResilienciaException(String message, Throwable cause) {
        super(message, cause);
    }
}
