...
class ResilienceMetricsListenerTest {
    ...
    class RetryEventHandling {
        ...
        void should_recordAttemptFailed_when_retryEventAttemptFailedEmitted() {
            ...
            verify(metrics, times(1)).record(any(RetryCounters.AttemptFailed.class));
        }
        ...
        void should_recordSuccess_when_retryEventSuccessEmitted() {
            ...
            verify(metrics, times(1)).record(any(RetryCounters.Success.class));
        }
        ...
        void should_recordExhausted_when_retryEventExhaustedEmitted() {
            ...
            verify(metrics, times(1)).record(any(RetryCounters.Exhausted.class));
        }
        ...
        void should_recordRejected_when_retryEventRejectedEmitted() {
            ...
            verify(metrics, times(1)).record(any(RetryCounters.Rejected.class));
        }
        ...
        void should_recordInterrupted_when_retryEventInterruptedEmitted() {
            ...
            verify(metrics, times(1)).record(any(RetryCounters.Interrupted.class));
        }
    }
    ...
    class TimeoutEventHandling {
        ...
        void should_recordSucceeded_when_timeoutEventSucceededEmitted() {
            ...
            verify(metrics, times(1)).record(any(TimeoutCounters.Succeeded.class));
        }
        ...
        void should_recordFailed_when_timeoutEventFailedEmitted() {
            ...
            verify(metrics, times(1)).record(any(TimeoutCounters.Failed.class));
        }
        ...
        void should_recordTimedOut_when_timeoutEventTimedOutEmitted() {
            ...
            verify(metrics, times(1)).record(any(TimeoutCounters.TimedOut.class));
        }
        ...
        void should_recordAbandoned_when_abandonedWorkerSucceededEmitted() {
            ...
            verify(metrics, times(1)).record(any(TimeoutCounters.Abandoned.class));
        }
    ...
    class CircuitBreakerEventHandling {
        ...
        void should_recordCallRecordedAndFailureRate_when_callRecordedEmitted() {
            ...
            order.verify(metrics).record(any(CircuitBreakerCounters.CallRecorded.class));
            order.verify(metrics).record(any(CircuitBreakerSnapshot.FailureRate.class));
        ...
        void should_recordTransitionToOpen_when_openedEventEmitted() {
            ...
            verify(metrics, times(1)).record(any(CircuitBreakerCounters.Transition.class));
        }
        ...
        void should_recordTransitionToClosedAndClosedFromHalfOpen_when_closedEventEmitted() {
            ...
            var order = inOrder(metrics);
            order.verify(metrics).record(any(CircuitBreakerCounters.Transition.class));
            order.verify(metrics).record(any(CircuitBreakerCounters.ClosedFromHalfOpen.class));
            order.verifyNoMoreInteractions();
        }
        ...
        void should_recordRejected_when_rejectedEventEmitted() {
            ...
            verify(metrics, times(1)).record(any(CircuitBreakerCounters.Rejected.class));
        }
    }
    ...
    class BulkheadEventHandling {
        ...
        void should_recordPermittedAndActiveCalls_when_permittedEventEmitted() {
            ...
            var order = inOrder(metrics);
            order.verify(metrics).record(any(BulkheadCounters.Call.class));
            order.verify(metrics).record(any(BulkheadSnapshot.ActiveCalls.class));
            order.verifyNoMoreInteractions();
        }
        ...
        void should_recordRejected_when_rejectedEventEmitted() {
            ...
            verify(metrics, times(1)).record(any(BulkheadCounters.Call.class));
        }
        ...
        void should_recordActiveCalls_when_finishedEventEmitted() {
            ...
            verify(metrics, times(1)).record(any(BulkheadSnapshot.ActiveCalls.class));
        }
    }
    ...
    class RateLimiterEventHandling {
        ...
        void should_recordPermittedAndRemainingPermits_when_permittedEventEmitted() {
            ...
            var order = inOrder(metrics);
            order.verify(metrics).record(any(RateLimiterCounters.Call.class));
            order.verify(metrics).record(any(RateLimiterSnapshot.RemainingPermits.class));
            order.verifyNoMoreInteractions();
        }
        ...
        void should_recordRejected_when_rejectedEventEmitted() {
            ...
            verify(metrics, times(1)).record(any(RateLimiterCounters.Call.class));
        }
    }
    ...
    class PolicyEventHandling {
        ...
        void should_recordValidationWarning_when_policyValidationWarningEmitted() {
            ...
            verify(metrics, times(1)).record(any(PolicyCounters.ValidationWarning.class));
        }
    }
    ...
    class ExceptionIsolation {
        ...
        void should_continueProcessing_when_recordSnapshotThrows() {
            ...
            verify(metrics, times(1)).record(any(CircuitBreakerCounters.CallRecorded.class));
            verify(metrics, times(1)).record(any(CircuitBreakerSnapshot.FailureRate.class));
        }

        @Test
        void should_continueProcessing_when_recordCountersThrows() {
            doThrow(new RuntimeException("Backend failure")).when(metrics)
                .record(any(Counters.class));
            var event = new RetryEvent.AttemptFailed(Instant.now(), "myRetry", 1,
                new RuntimeException("error"));

            listener.onEvent(event);

            verify(metrics, times(1)).record(any(Counters.class));
        }
        ...
        void should_isolateMultipleFailures_when_eventDrivesMultipleRecords() {
            doThrow(new RuntimeException("First failure")).when(metrics)
                .record(any(CircuitBreakerCounters.CallRecorded.class));
            doThrow(new RuntimeException("Second failure")).when(metrics)
                .record(any(CircuitBreakerSnapshot.FailureRate.class));
            var event = new CircuitBreakerEvent.CallRecorded(Instant.now(), "myCB", true,
                Duration.ofMillis(50), 0.1);
    ...
    class CardinalityControl {
        ...
        void should_useSimpleClassName_when_exceptionTypeInAllowlist() {
            ...
            verify(metrics).record(captor.capture());
        ...
        void should_boundCardinalityToAllowlistSize() {
            ...
            verify(metrics, times(4)).record(any(Counters.class));
        }
    }
    ...
    class UnknownEventHandling {
        ...
        void should_ignoreUnknownEvent_when_customPatternImplementsResilienceEvent() {
            ...
            verify(metrics, never()).record(any(Snapshot.class));
            verify(metrics, never()).record(any(Counters.class));
        }
    }
}
